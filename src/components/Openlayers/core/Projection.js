...
proj4490.setExtent([-180, -90, 180, 90]) // 73.62, 16.7, 134.77, 53.56
...
register(proj4)
const proj4544 = getProjection('EPSG:4544')
proj4544.setExtent([345643.07, 2489940.65, 623868.1, 4676052.19])
...
// Xian 1980
proj4.defs('EPSG:4610', '+proj=longlat +a=6378140 +b=6356755.288157528 +units=degrees +no_defs')
register(proj4)
